...
{
    public class SendEmailPOCRequirementCommand : SalesPOCRequirementMapperCommand
    {
        public SendEmailPOCRequirementCommand(SalesPOCRequirementMapperCommand obj)
        {
