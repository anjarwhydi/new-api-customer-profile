...
{
    public class FunnelSA_SendEmailSASubmitApprovalEvent : Event
    {
        public FunnelSA_SendEmailSASubmitApprovalEvent()
        {
        ...
        public FunnelSA_SendEmailSASubmitApprovalEvent(EmailSASubmitApprovalMapperCommand obj)
        {
