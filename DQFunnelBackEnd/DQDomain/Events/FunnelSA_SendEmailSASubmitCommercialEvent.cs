...
{
    public class FunnelSA_SendEmailSASubmitCommercialEvent : Event
    {
        public FunnelSA_SendEmailSASubmitCommercialEvent()
        {
        ...
        public FunnelSA_SendEmailSASubmitCommercialEvent(EmailSASubmitApprovalMapperCommand obj)
        {
