...
{
    public class Funnel_SendEmailPOCRequirementEvent : Event
    {
        public Funnel_SendEmailPOCRequirementEvent()
        {
        ...
        public Funnel_SendEmailPOCRequirementEvent(SalesPOCRequirementMapperCommand obj)
        {
